...
const DrfApiFetch = () => {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/tasks/', {
            headers: {
                'Authorization': 'Token 2aee8b53f58fed7d17c7158443e55340b748eabe'
            }
        })
    ...
    const getTask = () => {
        axios.get(`http://127.0.0.1:8000/api/tasks/${id}/`, { //文字列に変数を含んだ場合は、シングルクオーテーションをバッククーテーションに変更する
            headers: {
                'Authorization': 'Token 2aee8b53f58fed7d17c7158443e55340b748eabe'
            }
        })
    ...
    const deleteTask = (id) => {
        axios.delete(`http://127.0.0.1:8000/api/tasks/${id}/`, { //文字列に変数を含んだ場合は、シングルクオーテーションをバッククーテーションに変更する
            headers: {
                'Authorization': 'Token 2aee8b53f58fed7d17c7158443e55340b748eabe'
            }})
            .then((res) => {
